...
@Component({
  selector: 'app-svms-table-paginator',
  templateUrl: './svms-table-paginator.component.html',
  styleUrls: ['./svms-table-paginator.component.scss']
})
export class SvmsTablePaginatorComponent implements OnInit {
