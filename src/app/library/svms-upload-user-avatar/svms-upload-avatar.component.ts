...
@Component({
  selector: 'svms-upload-user-avatar',
  templateUrl: './svms-upload-avatar.component.html',
  styleUrls: ['./svms-upload-avatar.component.scss']
})
export class SvmsUploadUserAvatarComponent implements OnInit {
  ...
  removeUpload() {
    this.confirmService.confirm('', `Are you sure you want to delete the profile picture?`,
    'Yes', 'No')
    .then((confirmed) => {
      if(confirmed){
