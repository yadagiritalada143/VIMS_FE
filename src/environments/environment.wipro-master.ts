...
export const environment = {
  ...
  //Enable this in UAT /
  API_ENDPOINT: 'https://services-wipro.simplifyvms.com',
  REPORT_API_ENDPOINT: 'https://reports-wipro.simplifyvms.com',
  MOCK_ENDPOINT: 'https://services-wipro.simplifyvms.com',
  SSO_URL:
    'https://sso-wipro.simplifyvms.com/oauth2/authorize?client_id=3lbut4tev9v9431v2sp8ohag6j&response_type=code&scope=email+openid&redirect_uri=https://wipro.simplifyvms.com/auth/login',
  SSO_REDIRECT_URL: 'https://wipro.simplifyvms.com/auth/login',
  FRONTEND_APP_URL: 'https://wipro.simplifyvms.com',
